 ...
 * @author RABBAH
 */
public class EtatInventaireConverter implements TypeConverter {
    ...
    public Object coerceToUi(java.lang.Object val,
        ...
        if(string.equals("EN COURS")) {
            string = "En cours";
        } else if(string.equals("SUSPENDU")) {
            string = "Suspendu";
        } else if(string.equals("ACHEVE")) {
            string = "Achevé";
        } else if(string.equals("VALIDE")) {
            string = "Validé";
        } 
        return string;
    }
